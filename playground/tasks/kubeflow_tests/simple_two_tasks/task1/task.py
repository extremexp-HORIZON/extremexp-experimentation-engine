...
[file_obj] = utils.load_datasets_ddm(variables, "task1inputfile", resultMap)
df = pd.read_csv(file_obj)
print("Data from S3:", df.head())

utils.save_datasets_ddm(variables, resultMap, "output2", [df.to_csv(index=False).encode('utf-8')])

utils.save_datasets_ddm(variables, resultMap, "output1", ["I am here from task1".encode('utf-8')])
