...
variables = {'PREVIOUS_PROCESS_ID': 'Task1', 'task_name': 'Task2', 'workflow_id': '-fP0WZoBYAWZyMn0cZCO', 'TestDatasetManagementTask2InputFile': None, 'TestDatasetManagementTask2OutputFile': 'playground/datasets/output/test_local/titanic_once_more.csv'}
resultMap = {}
